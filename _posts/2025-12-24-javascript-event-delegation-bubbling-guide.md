...
│      window → document → html → body → ... → 타겟의 부모        │
│                          ↓                                      │
│   2. 타겟 단계 (Target Phase)                                    │
│      이벤트가 실제로 발생한 요소                                   │
│                          ↓                                      │
│   3. 버블링 단계 (Bubbling Phase)                                │
│      타겟의 부모 → ... → body → html → document → window        │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
┌────────────────────────────────────────────────────────────────┐
│                                                                │
│   <ul id="list">           ← 핸들러가 여기에 등록됨             │
│     <li>                      (event.currentTarget)           │
│       <button>클릭</button> ← 실제 클릭된 요소                  │
│     </li>                     (event.target)                  │
│   </ul>                                                        │
│                                                                │
└────────────────────────────────────────────────────────────────┘
...
│                   React 이벤트 위임 방식 변화                    │
├─────────────────────────────┬──────────────────────────────────┤
│       React 16 이하         │        React 17 이상             │
├─────────────────────────────┼──────────────────────────────────┤
│                             │                                  │
│   document에 이벤트 위임     │   root 컨테이너에 이벤트 위임     │
│                             │                                  │
│   <html>                    │   <html>                         │
│     <body>                  │     <body>                       │
│       <div id="root">       │       <div id="root"> ← 여기     │
│         <App />             │         <App />                  │
│       </div>                │       </div>                     │
│     </body>                 │     </body>                      │
│   </html> ← 여기            │   </html>                        │
