...
<div style="margin: 30px auto; max-width: 500px;">
  <div style="border: 5px solid #2ecc71; padding: 0; background: #e8f5e9; position: relative;">
    <div style="position: absolute; right: -160px; top: 50%; transform: translateY(-50%); color: #2ecc71; font-size: 13px; font-weight: bold; white-space: nowrap;">← width: 200px이 전체 너비</div>
