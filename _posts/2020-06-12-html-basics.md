...
description: HTML의 개념부터 브라우저의 동작 원리, 태그의 구조와 속성까지 웹 개발의 기초를 탄탄하게 다지는 입문 가이드입니다. 초보자도 쉽게 따라할 수 있는 실전 예제와 함께 HTML5의 시맨틱 태그 활용법을 배우고, 웹 표준을 준수하는 마크업 작성법을 익힙니다.
author: changsu
